...
//         error_log(print_r($check_values, true));
...
//             error_log(print_r('in loop', true));
...
//         header("Location: " . "http://" . $_SERVER['HTTP_HOST'] . '/wp-admin/options-general.php?page=my-setting-damin');
//         exit;
//     }
// }
